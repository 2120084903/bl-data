$(function() {
    ...
    function nextclick() {
        ...
        if (currrentindex != (length - 1)) {
            ...
            curli.find("a").removeClass("selectpic");
            curnextli.find("a").addClass("selectpic");
    ...
    getli.click(function() {
        ...
        $(".picmidmid ul li a[class='selectpic']").removeClass("selectpic");
        var currentli = getli.eq(currentliindex);
        currentli.find("a").addClass("selectpic");
    ...
    $(".replaybtn2").click(function() {
        $(".endtop").css("display", "none");
        $(".bodymodal").css("display", "none");
        $(".detail_picbot_mid ul li a[class='selectpic']").removeClass("selectpic");
        $(".detail_picbot_mid ul li").eq(0).find("a").addClass("selectpic");
