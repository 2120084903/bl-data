...
option = {
    ...
    legend: {
        ...
        data:['林业部','文娱部','公安部','发改委','工信部','交通部','商务部','央行']
    },
    series : [
        {
            name: '政府部门',
...
var dom6 = document.getElementById("ytcs");
    ...
    series : [
        {
            ...
            barWidth : 20,//柱图宽度
            barMaxWidth:30,//最大宽度
            data:[100, 52, 200, 334, 390, 330, 220, 163, 100, 30, 165, 93],
            itemStyle: {
                normal:{color:'#3498D9'}, //柱形的颜色(默认玫红/深红色)
                emphasis:{color:'#39A7EE'} //鼠标悬停变色
            },
            markPoint : {
                data : [
                    {type : 'max', name: '最大值'},
